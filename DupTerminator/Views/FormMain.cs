...
{
    internal partial class FormMain : BaseForm, IMainView
    {
    ...
    FileAttributes.ReadOnly | FileAttributes.System));
        ...
        private void SetVistaProgressState(TBPFLAG tBPFLAG)
        {
            if ((Environment.OSVersion.Version.Major == 6 && Environment.OSVersion.Version.Minor >= 1)
                || Environment.OSVersion.Version.Major > 6)
                taskbarProgress.SetProgressState(this.Handle, tBPFLAG);
        }
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            if (_stateofSearch == StateOfSearch.Search)
            {
                ...
                SetVistaProgressState(TBPFLAG.TBPF_PAUSED);
                return;
            }
            if (_stateofSearch == StateOfSearch.Pause)
            {
                ...
                SetVistaProgressState(TBPFLAG.TBPF_NORMAL);
                return;
            }
