...
namespace DupTerminator.Views
{
    internal partial class FormSetting : BaseForm
    {
        ...
        {
            labelSizeDatabase.Text = LanguageManager.GetProperty(this, "labelSizeDatabase.Text") + " " + DBManager.GetInstance().GetSizeDB();
        }
        ...
        private void checkBoxUseDB_Click(object sender, EventArgs e)
        {
            ...
            {
                DBManager.GetInstance().Active = false;
                buttonCleanDB.Enabled = false;
                buttonDeleteDB.Enabled = false;
            }
        }
        ...
        private void buttonCleanDB_Click(object sender, EventArgs e)
        {
            ...
            dbManager.ProgressChangedEvent += new DBManager.ProgressChangedDelegate(_formProgress.ProgressChangedEventHandler);
            ...
            _formProgress.CancelEvent += new FormProgress.CancelDelegate(dbManager.CancelDeletingEventHandler);
        ...
        private void DeletingCompletedEventHandler()
        {
            ...
            DBManager.GetInstance().ProgressChangedEvent -= new DBManager.ProgressChangedDelegate(_formProgress.ProgressChangedEventHandler);
            DBManager.GetInstance().DeletingCompletedEvent -= new DBManager.DeletingCompletedDelegate(DeletingCompletedEventHandler);
            DBManager.GetInstance().SetMaxValueEvent -= new DBManager.SetMaxValueDelegate(SetMaxValueEventHandler);
            _formProgress.Close();
