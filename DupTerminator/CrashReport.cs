...
using System.Threading; //NetworkCredential
...
namespace DupTerminator
{
    internal partial class CrashReport : BaseForm
    {
        ...
        private const string feedbackPassword = "";
        #endregion

        private string _screenShot;

        public CrashReport(Exception ex)                        : this(null, ex, null, null)        { }
        public CrashReport(string msg)                          : this(msg, null, null, null)       { }
        public CrashReport(string msg, ListView lv)             : this(msg, null, null, lv)         { }
        public CrashReport(string msg, Exception ex)            : this(msg, ex, null, null)         { }
