...
//        public async Task<IEnumerable<ExtendedFileInfo>?> Get(string path, DateTime lastWriteTime, ulong size)
//        {
//            using var connection = new SqliteConnection(_connectionString);
...
//                return JsonSerializer.Deserialize<ExtendedFileInfo[]>(data, _jsonOptions);
//            }

//            return null;
//        }

//        public void Add(ExtendedFileInfo container, IEnumerable<ExtendedFileInfo> files)
//        {
//            using var connection = new SqliteConnection(_connectionString);
//            connection.Open();
