...
//    {
//        private const string SQL_CONNECTION_FILE = "Data Source={0}";
...
//        {
//            _dbPath = "database.db3";
//            _messageService = messageService ?? throw new ArgumentNullException(nameof(messageService));

//            _sqliteConnection = new SqliteConnection(SQL_CONNECTION_MEMORY);
...
//                using (SqliteConnection sqliteConnectionFile = new SqliteConnection(String.Format(SQL_CONNECTION_FILE, _dbPath)))
//                {
